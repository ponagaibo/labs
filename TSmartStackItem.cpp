...
template <class T> TAllocationBlock TSmartStackItem<T>::allocator(sizeof(TSmartStackItem<T>),100);

template <class T> void* TSmartStackItem<T>::operator new(size_t size) {
    return allocator.Allocate();
}

template <class T> void TSmartStackItem<T>::operator delete(void *pointer) {
