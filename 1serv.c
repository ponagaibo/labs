...
//.........................................................
    ...
    while (1) {
        ...
        while (!strcmp(cmd, "shoot")) {
            ...
            if (secondArea[l][col] == '~') {
                secondArea[l][col] = '*';
                if (Miss(secondArea, respond1, respond2)) return -1;
                break; 
                ...
                if (CheckIfKilled(l, col, secondArea, player2)) {
                    if (CheckVictory() == 1) {
                        ...
                        if (EndGame(respond1, respond2)) return -1;
                        return 0;
                    }
                    sprintf(ans, "killed ");
        ...
        while (!strcmp(cmd, "shoot")) {
            ...
            if (firstArea[l][col] == '~') {
                firstArea[l][col] = '*';
                if (Miss(firstArea, respond2, respond1)) return -1;
                break; 
                ...
                if (CheckIfKilled(l, col, firstArea, player1)) {
                    if (CheckVictory() == 2) {
                        ...
                        if (EndGame(respond2, respond1)) return -1;
                        return 0;
                    }
                    sprintf(ans, "killed ");
                } else sprintf(ans, "injured ");
                AddToAnswer(firstArea, ans, 1);
                if (zmq_send(respond2, ans, strlen(ans), 0) == -1) {
                    printf("Error! Can not send message61.\n");
                    Free();
                    return -1;
