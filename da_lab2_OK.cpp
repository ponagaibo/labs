        ...
        if(action == '+') {
            ...
            if (!strcmp(act, "Load")) {
                ...
                if (f) {
                    ...
                    if (fclose(f) == EOF) {
                        std::cout << "ERROR: can not load (close) tree." << std::endl;
                    }
                } else {
                    std::cout << "ERROR: can not load (open) tree." << std::endl;
                }
                ...
                if (f) {
                    ...
                    std::cout << "OK" << std::endl;
                    if (fclose(f) == EOF) {
                        std::cout << "ERROR: can not save (close file) tree." << std::endl;
                    }
                } else {
                    std::cout << "ERROR: can not save (open file) tree." << std::endl;
                }
