...
bool TTrapeze::operator==(TFigure& other) {
...
void TTrapeze::Print() {
    std::cout << "TRAPEZE: a = " << side_a << ", b = " << side_b << ", h = " << h << ", square = " << SquareOfFigure() << std::endl;
}
/*
TAllocationBlock TTrapeze::allocator(sizeof(TTrapeze),500);

void* TTrapeze::operator new(size_t size) {
    return allocator.Allocate();
}

void TTrapeze::operator delete(void *pointer) {
